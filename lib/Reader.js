...
Reader.prototype.write = function(newBuffer) {
  ...
  if (reuseBuffer) {
    ...
    this._buffer.set(Uint8Array(this._buffer.slice(this._offset)), this._offset - newBuffer.byteLength);
    ...
    this._buffer.set(Uint8Array(oldBuffer.buffer.slice(this._offset)));
    this._buffer.set(newBuffer, bytesAhead);
