  ...
  function updateButton(value, gamepadId, label) {
    ...
    if(active && value === 1) {
      switch(label) {
        ...
        case 'button-right-shoulder-bottom':
          DRONE.API.animateNext();
          break;

        case 'button-left-shoulder-bottom':
          DRONE.API.animatePrev();
          break;
        ...
        case 'button-1':
          DRONE.API.animateLed(1);
          break;

        case 'button-2':
          DRONE.API.animateLed(2);
          break;

        case 'button-3':
          DRONE.API.animateLed(3);
          break;

        case 'button-4':
          DRONE.API.animateLed(4);
          break;
      }
    }
